  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/">Home</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/about/">About</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/overview/">Project Overview</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/team/">Team</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/adaptive/">Adaptive Experiment</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/">Conferences &amp; Events</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/workshops/">SIPS Workshop</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/participate/">Participate</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/">Documentation</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/mooclet/">MOOClet</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/upgrade/">UpGrade</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/oli/">OLI</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/research/">Experiment</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/mooclet/">A/B Testing</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/mooclet/">Contextual Exp</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/ADAPTIVEEXPERIMENTS/mooclet/">Non-Contextual</a></li>
	...
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/ADAPTIVEEXPERIMENTS/" title="EASI – Experiments-As-A-Service-Infrastructure">
				<img src="http://localhost:4000/ADAPTIVEEXPERIMENTS/assets/img/easi.png" alt="EASI – Experiments-As-A-Service-Infrastructure">
			</a>
